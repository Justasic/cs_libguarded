...
namespace libguarded
{
	...
	*/
	  ...
	  private:
		class shared_deleter
		{
		  public:
			...
			shared_deleter(shared_deleter &&other): m_readingCount(other.m_readingCount) { other.m_readingCount = nullptr; }
	...
	lr_guarded<T, M>::lr_guarded(Us &&...data)
		: m_left(std::forward<Us>(data)...), m_right(m_left), m_readingLeft(true), m_countingLeft(true), m_leftReadCount(0), m_rightReadCount(0)
	{}
