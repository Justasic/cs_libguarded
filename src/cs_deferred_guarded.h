	...
	*/
	...
	class deferred_guarded
	{
	  ...
	  public:
		...
		template<typename Func>
		[[nodiscard]] auto          modify_async(Func &&func) -> typename std::future<decltype(std::declval<Func>()(declref<T>()))>;
	...
	template<typename... Us>
	deferred_guarded<T, M>::deferred_guarded(Us &&...data): m_obj(std::forward<Us>(data)...), m_pendingWrites(false)
	{}
	...
	auto call_returning_future(Func &func, T &data) -> typename std::enable_if<!std::is_same<Ret, void>::value, std::future<Ret>>::type
	{
	...
	auto package_task_void(Func &&func) -> typename std::enable_if<std::is_same<Ret, void>::value, std::pair<std::packaged_task<void(T &)>, std::future<void>>>::type
	{
	...
	template<typename Ret, typename T, typename Func>
	auto package_task_void(Func &&func) -> typename std::enable_if<!std::is_same<Ret, void>::value, std::pair<std::packaged_task<void(T &)>, std::future<T>>>::type
	{
	...
	template<typename T, typename M>
	template<typename Func>
	auto deferred_guarded<T, M>::modify_async(Func &&func) -> typename std::future<decltype(std::declval<Func>()(declref<T>()))>
	{
		...
		{
			std::pair<std::packaged_task<void(T &)>, std::future<return_t>> task_future = package_task_void<return_t, T>(std::forward<Func>(func));
